...
class HiggsImputationDataset(BaseDataset):
    def __init__(self, c):
        super(HiggsImputationDataset, self).__init__(
            # TODO: fixed test set for imputation?
            is_imputation=True,
...
def load_and_preprocess_higgs_dataset(c):
    ...
    # TODO: it's unclear if higgs has missing values
    # TODO: there is no documentation, but some columns are often 0
    # TODO: there is a related dataset at
    # TODO: https://www.kaggle.com/c/higgs-boson/discussion/9552
    # TODO: (has similar sounding feture names)
    # TODO: which does seem to have missing values!
    # TODO: and our dataset also seems to have a lot of values which are
    # TODO: exactly equal to 0 (about 29 Mio!)
