...
class IncomeDataset(BaseDataset):
    ...
    def load(self):
        ...
        # we are not excluding 'instance_weight' column
        # even though
        # https://archive.ics.uci.edu/ml/datasets/Census-Income+%28KDD%29
        # that is because openml algorithms surely also do not exclude it
        # maybe change this in the future?
        # also we don't know if TabNet / VIME exclude it
        # will reach out to authors
