...
class ForestCoverImputationDataset(BaseDataset):
    def __init__(self, c):
        # TODO: fixed test set for imputation?
        super(ForestCoverImputationDataset, self).__init__(
            is_imputation=True, fixed_test_set_index=None)
        self.c = c
    ...
    def load(self):
        ...
        # For imputation, there is no target col
        self.num_target_cols = []
