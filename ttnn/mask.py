...
from ttnn.constants import (
    DATA_MODE_TO_LABEL_BERT_MODE, DATA_MODE_TO_LABEL_BERT_FIXED)
from ttnn.utils.encode_utils import get_torch_dtype, get_torch_tensor_type
...
def apply_mask(
    ...
    """
    # I don't think we need this here, since we already copy at the top of
    # mask_data()
    # data_arrs = data_arrs.copy()
